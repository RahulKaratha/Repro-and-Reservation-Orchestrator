...
/* =========================================
   ...
   ========================================= */
const API_BASE = 'http://localhost:5001'; // Change this to your backend URL
...
const dummyReproBugs = [
    { id: 'REPRO-1234', engineer: { initials: 'JS', name: 'John Smith', color: '#7c3aed' }, tests: ['Test A', 'Test B', 'Test C'], stations: ['Station 1', 'Station 2'], config: 'Config A', resourceGroup: '' },
    { id: 'REPRO-1235', engineer: { initials: 'JD', name: 'Jane Doe', color: '#7c3aed' }, tests: ['Test D', 'Test E'], stations: ['Station 3'], config: 'Config B', resourceGroup: '' },
    { id: 'REPRO-1236', engineer: { initials: 'MJ', name: 'Mike Johnson', color: '#7c3aed' }, tests: ['Test F', 'Test G', 'Test H', 'Test I'], stations: ['Station 1', 'Station 4'], config: 'Config C', resourceGroup: '' },
];

const dummyTestBugs = [
    { id: 'TEST-5678', engineer: { initials: 'SW', name: 'Sarah Williams', color: '#7c3aed' }, tests: ['Test J', 'Test K'], stations: ['Station 5', 'Station 6'], config: 'Config D', resourceGroup: '' },
    { id: 'TEST-5679', engineer: { initials: 'DB', name: 'David Brown', color: '#7c3aed' }, tests: ['Test L'], stations: ['Station 2'], config: 'Config E', resourceGroup: '' },
    { id: 'TEST-5680', engineer: { initials: 'ED', name: 'Emily Davis', color: '#7c3aed' }, tests: ['Test M', 'Test N', 'Test O', 'Test P'], stations: ['Station 7', 'Station 8', 'Station 9'], config: 'Config F', resourceGroup: '' },
];

async function loadBugsData() {
    // In future, fetch from API here. For now, use dummy data.
    renderStats({
        totalBugs: dummyReproBugs.length + dummyTestBugs.length,
        reproBugs: dummyReproBugs.length,
        testBugs: dummyTestBugs.length,
        pendingActions: dummyReproBugs.length + dummyTestBugs.length
    });

    renderBugs(dummyReproBugs, dummyTestBugs);
}
